#!/usr/bin/env python3
"""
Run a regime-filter sweep for the equity momentum strategy.

Compares walk-forward out-of-sample performance for different regime
filter configurations while keeping momentum weights, portfolio construction,
and friction assumptions fixed.

Run:
    python -m research.run_regime_filter_sweep
"""
...
def main() -> None:
    regime_configs = [
        {"label": "baseline_200_0bp", "market_sma_days": 200, "risk_on_buffer": 0.00},
        {"label": "strict_200_1pct", "market_sma_days": 200, "risk_on_buffer": 0.01},
        {"label": "strict_200_2pct", "market_sma_days": 200, "risk_on_buffer": 0.02},
        {"label": "faster_150_0bp", "market_sma_days": 150, "risk_on_buffer": 0.00},
        {"label": "slower_250_0bp", "market_sma_days": 250, "risk_on_buffer": 0.00},
    ]
    ...
    for regime in regime_configs:
        print(f"[INFO] Running walk-forward for {regime['label']}...")
        ...
        cfg = WalkForwardConfig(
            ...
            w_6m=0.30,
            w_12m=0.10,
            market_sma_days=regime["market_sma_days"],
            risk_on_buffer=regime["risk_on_buffer"],
        )
