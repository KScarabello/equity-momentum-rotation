#!/usr/bin/env python3
"""
Run an SMA slope filter sweep for the equity momentum strategy.

Tests whether requiring the 200-day SMA to be rising (in addition to price
being above it) reduces participation in choppy/deteriorating markets and
improves risk-adjusted returns.

Run:
    python -m research.run_sma_slope_filter_sweep
"""
...
def main() -> None:
    ...
    for c in configs:
        ...
        cfg = WalkForwardConfig(
            **BASE_CFG,
            require_positive_sma_slope=c["require_positive_sma_slope"],
            sma_slope_lookback=c["sma_slope_lookback"],
        )
